...
export default async function Video({ params }: PageProps) {
    ...
    if (data.status !== 200) {
        ...
        url: `https://bokepindowiki.pages.dev/v/${file.file_code}#${file.file_title}`,
        ...
        publisher: {
            '@type': 'Organization',
            name: `${SITENAME}`,
            logo: 'https://bokepindowiki.pages.dev/favicon.ico'},
            author: {
                '@type': 'Person',
                name: 'admin',
                url: 'https://bokepindowiki.pages.dev'
              }
        }
        const jsonLd2 = {
        '@context': 'https://schema.org',
        ...
        interactionStatistic: {
            ...
            interactionType: {
                '@type': `ReadAction`,
                target: `https://bokepindowiki.pages.dev/v/${file.file_code}#${file.file_title}`
            }  
        }
        }
